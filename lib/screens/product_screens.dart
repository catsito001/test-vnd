...
class _NewProductScreenState extends State<NewProductScreen> {
  ...
  Future<void> _openLinkSheet() async {
    ...
    final linked = await showLinkExistingProductSheet(context, code);
    if (linked != null && mounted) Navigator.of(context).pop(linked);
  }
  ...
  Future<void> _save() async {
    ...
    if (mounted) Navigator.of(context).pop(savedProduct);
  }
...
Future<Product?> showLinkExistingProductSheet(BuildContext context, String barcode) {
