...
class _ProductCatalogScreenState extends State<ProductCatalogScreen> {
  ...
  Future<void> _openNewProductFlow() async {
    ...
    if (saved != null && mounted) {
      _load();
      // El Catálogo es parte del flujo de venta (se abre encima de la
      // vista principal), así que un producto recién agregado/vinculado
      // acá también se suma al carrito de una vez.
      await _addToCart(saved);
    }
  }
